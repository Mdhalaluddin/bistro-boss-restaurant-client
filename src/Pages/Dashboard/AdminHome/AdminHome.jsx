...
const COLORS = ["#0088FE", "#00C49F", "#FFBB28", "#FF8042", '#FFCC80', '#00BBFF'];
...
const AdminHome = () => {
    ...
    const pieChartData = dataChat.map(data => {
    ...
    return (
        <div className="bg-[#F6F6F6] p-10">
            <h2 className="text-2xl my-3">
                ...
                {
                    users?.displayName ? 'user.displayName' : 'Back'
                }
            </h2>
            <div className="w-full">
                <div className="stats shadow w-full px-10">
